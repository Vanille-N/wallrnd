    ...
    periodic_grid_tiling(
        ...
        |pos| {
            vec![
                ...
                mv[9].render(pos - mv[3].vertex(2) + mv[3].vertex(4) - mv[9].vertex(4)),
                mv[10].render(pos - mv[4].vertex(2) + mv[4].vertex(4) - mv[10].vertex(4)),
                mv[11].render(pos - mv[5].vertex(2) + mv[5].vertex(4) - mv[11].vertex(4)),
            ]
        },
        idir,
        jdir,
